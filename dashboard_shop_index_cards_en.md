# Dashboard Shop Index - content proposal (trader)

## Objective
Propose content for each card in `dashboard_shop_index.html` using `database_model_reference.md`, focused on sales, retention, and acquisition for the trader.
